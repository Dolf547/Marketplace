...
class MPRestClient {
    ...
    private static function build_request($request) {
        ...
        curl_setopt($connect, CURLOPT_USERAGENT, "MELI-PHP-SDK-1.1.0");
    ...
    // private static function exec($method, $uri, $data, $content_type) {
        ...
        if ($api_result === FALSE) {
            ...
            print_r('Erro na conexão:<br/>');
            print_r($request);
            //die();
            set_alert('danger', _l('mercadolivre_not_connect'));
            redirect(admin_url('mercadolivre'));
...
/* End of file MPRestClient.php */
/* Location: ./application/libraries/MPRestClient.php */
